...
def save_lessons_files(instance, filename):
    import os
    upload_to = 'Images/'
    ext = filename.split('.')[-1]
...
class Lesson(models.Model):
    ...
    slug = models.SlugField(blank=True, null=True)
    video = models.FileField(upload_to=save_lessons_files, verbose_name="video", blank=True, null=True)
    ppt = models.FileField(upload_to=save_lessons_files, verbose_name="presentation", blank=True)
    Notes = models.FileField(upload_to=save_lessons_files, verbose_name="Notes", blank=True)
